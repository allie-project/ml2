...
pub fn blobs(blob_size: usize, blob_centroids: &ArrayBase<impl Data<Elem = f64>, Ix2>, rng: &mut impl Rng) -> Array2<f64> {
...
fn make_blob(blob_size: usize, blob_centroid: &ArrayBase<impl Data<Elem = f64>, Ix1>, distribution: impl Distribution<f64>, rng: &mut impl Rng) -> Array2<f64> {
