...
use super::NaiveBayesError;
use crate::core::{Float, ParamGuard};

/// A verified hyper-parameter set ready for the estimation of a [Gaussian Naive Bayes
/// model](crate::bayes::gaussian_nb::GaussianNb).
///
...
/// A hyper-parameter set during construction for a [Gaussian Naive Bayes model](crate::bayes::gaussian_nb::GaussianNb).
///
/// The parameter set can be verified into a
/// [`GaussianNbValidParams`](crate::bayes::hyperparams::GaussianNbValidParams) by calling
/// [ParamGuard::check](Self::check). It is also possible to directly fit a model with
/// [Fit::fit](crate::core::traits::Fit::fit) or
/// [FitWith::fit_with](crate::core::traits::FitWith::fit_with) which implicitely verifies the parameter set
/// prior to the model estimation and forwards any error.
///
/// See [`GaussianNb`](crate::bayes::gaussian_nb::GaussianNb) for information on the model.
///
/// # Parameters
/// | Name | Default | Purpose | Range |
/// | :--- | :--- | :---| :--- |
/// | [var_smoothing](Self::var_smoothing) | `1e-9` | Stabilize variance calculation if ratios are small in update step
/// | `[0, inf)` |
///
/// # Errors
///
...
impl<F: Float, L> ParamGuard for GaussianNbParams<F, L> {
	...
	fn check_ref(&self) -> Result<&Self::Checked, Self::Error> {
		if self.0.var_smoothing.is_negative() {
			Err(NaiveBayesError::InvalidSmoothing(self.0.var_smoothing.to_f64().unwrap()))
		} else {
			Ok(&self.0)
		}
	}
...
/// A verified hyper-parameter set ready for the estimation of a [Multinomial Naive Bayes
/// model](crate::bayes::multinomial_nb::MultinomialNb).
///
...
/// A hyper-parameter set during construction for a [Multinomial Naive Bayes
/// model](crate::bayes::multinomial_nb::MultinomialNb).
///
/// The parameter set can be verified into a
/// [`MultinomialNbValidParams`](crate::bayes::hyperparams::MultinomialNbValidParams) by calling
/// [ParamGuard::check](Self::check). It is also possible to directly fit a model with
/// [Fit::fit](crate::core::traits::Fit::fit) or
/// [FitWith::fit_with](crate::core::traits::FitWith::fit_with) which implicitely verifies the parameter set
/// prior to the model estimation and forwards any error.
///
/// See [`MultinomialNb`](crate::bayes::multinomial_nb::MultinomialNb) for information on the model.
///
/// # Parameters
/// | Name | Default | Purpose | Range |
/// | :--- | :--- | :---| :--- |
...
impl<F: Float, L> ParamGuard for MultinomialNbParams<F, L> {
	...
	fn check_ref(&self) -> Result<&Self::Checked, Self::Error> {
		if self.0.alpha.is_negative() {
			Err(NaiveBayesError::InvalidSmoothing(self.0.alpha.to_f64().unwrap()))
		} else {
			Ok(&self.0)
		}
	}
