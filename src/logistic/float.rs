...
use super::argmin_param::ArgminParam;

/// A Float trait that captures the requirements we need for the various places we use floats. These are basically
/// imposed by ndarray and argmin.
pub trait Float:
	ArgminFloat
	+ NdFloat
	+ Default
