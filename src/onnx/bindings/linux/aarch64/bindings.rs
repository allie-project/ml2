...
fn bindgen_test_layout___pthread_mutex_s__bindgen_ty_1__bindgen_ty_1() {
	...
	fn test_field___espins() {
		assert_eq!(
			unsafe {
				let uninit = ::std::mem::MaybeUninit::<__pthread_mutex_s__bindgen_ty_1__bindgen_ty_1>::uninit();
				let ptr = uninit.as_ptr();
				::std::ptr::addr_of!((*ptr).__espins) as usize - ptr as usize
			},
			0usize,
...
fn bindgen_test_layout___pthread_mutex_s__bindgen_ty_1() {
	...
	fn test_field___elision_data() {
		assert_eq!(
			unsafe {
				let uninit = ::std::mem::MaybeUninit::<__pthread_mutex_s__bindgen_ty_1>::uninit();
				let ptr = uninit.as_ptr();
				::std::ptr::addr_of!((*ptr).__elision_data) as usize - ptr as usize
			},
			0usize,
			concat!("Offset of field: ", stringify!(__pthread_mutex_s__bindgen_ty_1), "::", stringify!(__elision_data))
		);
	}
	test_field___elision_data();
...
fn bindgen_test_layout___pthread_cond_s__bindgen_ty_1__bindgen_ty_1() {
	...
	fn test_field___low() {
		assert_eq!(
			unsafe {
				let uninit = ::std::mem::MaybeUninit::<__pthread_cond_s__bindgen_ty_1__bindgen_ty_1>::uninit();
				let ptr = uninit.as_ptr();
...
fn bindgen_test_layout___pthread_cond_s__bindgen_ty_2__bindgen_ty_1() {
	...
	fn test_field___low() {
		assert_eq!(
			unsafe {
				let uninit = ::std::mem::MaybeUninit::<__pthread_cond_s__bindgen_ty_2__bindgen_ty_1>::uninit();
				let ptr = uninit.as_ptr();
				::std::ptr::addr_of!((*ptr).__low) as usize - ptr as usize
			},
			0usize,
