...
fn bindgen_test_layout___pthread_mutex_s__bindgen_ty_1__bindgen_ty_1() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<__pthread_mutex_s__bindgen_ty_1__bindgen_ty_1>())).__espins as *const _ as usize },
		0usize,
		concat!("Offset of field: ", stringify!(__pthread_mutex_s__bindgen_ty_1__bindgen_ty_1), "::", stringify!(__espins))
	);
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<__pthread_mutex_s__bindgen_ty_1__bindgen_ty_1>())).__eelision as *const _ as usize },
		2usize,
...
fn bindgen_test_layout___pthread_mutex_s__bindgen_ty_1() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<__pthread_mutex_s__bindgen_ty_1>())).__elision_data as *const _ as usize },
		0usize,
		concat!("Offset of field: ", stringify!(__pthread_mutex_s__bindgen_ty_1), "::", stringify!(__elision_data))
	);
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<__pthread_mutex_s__bindgen_ty_1>())).__list as *const _ as usize },
		0usize,
