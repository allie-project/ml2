...
///
/// The generated matrix is a upper triangular matrix with dimension NxN (number of observations) and contains the
/// similarity between all permutations of observations similarity
pub fn to_gaussian_similarity<F: Float>(observations: &ArrayBase<impl Data<Elem = F>, Ix2>, eps: F, dist_fn: &impl Distance<F>) -> Array2<F> {
