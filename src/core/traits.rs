...
use crate::core::dataset::{DatasetBase, Records};
...
/// hyperplane. Returns a model which can be used to predict targets for new data.
pub trait Fit<R: Records, T, E: std::error::Error + From<crate::core::error::Error>> {
	type Object;
...
pub trait FitWith<'a, R: Records, T, E: std::error::Error + From<crate::core::error::Error>> {
	type ObjectIn: 'a;
	type ObjectOut: 'a;
